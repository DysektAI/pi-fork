...
| `markdown.codeBlockBorderStyle` | `"fence" \| "rule" \| "label" \| "none"` | `"fence"` | How fenced code blocks are framed: literal fences, horizontal rules, a label, or indentation only. |
